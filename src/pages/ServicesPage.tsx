...
import { CheckCircle2, Briefcase, ShieldCheck, Scale, LucideIcon } from "lucide-react";
...
export function ServicesPage() {
  ...
  const openForService = useCallback(
    (serviceId: string, serviceTitle: string) => {
      openConsultation({
        source: "services-cta",
        context: { serviceId, serviceTitle },
      });
    },
    [openConsultation],
  );
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="py-8 md:py-10 lg:py-12">
        <div className="w-full">
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                  ...
                  <h1 className="text-4xl md:text-7xl font-serif font-bold text-white mb-8 leading-[1.1]">
                    Mastering Legal Complexity <br className="hidden md:block" /> in Global Markets
                  </h1>
          ...
          {/* Detailed Services Breakdown (full-bleed) */}
          <FullBleed>
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                {SERVICES.map((service, idx) => {
                  ...
                  return (
                    <div
                      key={service.id}
                      className={`flex flex-col lg:flex-row gap-20 items-center mb-40 last:mb-0 ${isEven ? "" : "lg:flex-row-reverse"}`}
                    >
                      <div className="flex-1 space-y-10">
                        ...
                        <p className="text-lg text-muted-foreground leading-relaxed font-light">{service.longDescription}</p>
                        ...
                        <div className="pt-6">
                          <Button
                            size="lg"
                            onClick={() => openForService(service.id, service.title)}
                            className="rounded-full px-10 h-16 bg-[#0F172A] hover:bg-[#B45309] transition-all shadow-xl"
                          >
                        ...
                        >
                          <img
                            src={`https://images.unsplash.com/photo-${
                              idx === 0 ? "1450101499163-c8848c66ca85" : idx === 1 ? "1589829545856-d10d557cf95f" : "1505664194779-8beaceb93744"
                            }?w=800&q=80`}
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  {CASE_STUDIES.map((study) => (
                    <Card
                      key={study.id}
                      className="overflow-hidden border-none shadow-soft hover:shadow-glow-lg transition-all duration-500 rounded-[2.5rem] group"
                    >
                      <div className="aspect-[16/10] relative overflow-hidden">
                        ...
                        <div className="absolute bottom-10 left-10 right-10">
                          <span className="text-[#B45309] font-bold text-xs uppercase tracking-[0.3em] mb-3 block">
                            {study.client}
                          </span>
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-24">
                  ...
                  <p className="text-slate-400 max-w-2xl mx-auto font-light leading-relaxed">
                    A disciplined, three-phase approach to securing elite legal outcomes for global industry leaders.
                  </p>
                </div>
                  ...
                  {[
                    {
                      step: "01",
                      title: "Consultation",
                      desc: "In-depth surgical analysis of the business landscape, regulatory risks, and strategic goals.",
                    },
