...
export function HomePage() {
  ...
  const handleHeroConsultation = useCallback(() => {
    openConsultation({ source: "home-hero" });
  }, [openConsultation]);
  return (
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-6">
                    <Button
                      ...
                      className="px-10 h-16 text-lg rounded-full bg-[#B45309] hover:bg-[#92400E] text-white border-none shadow-glow transition-all"
                    >
                    ...
                    <Button
                      ...
                      variant="outline"
                      asChild
                      className="px-10 h-16 text-lg rounded-full bg-white/5 text-white border-white/20 hover:bg-white/10 transition-all"
                    >
          ...
          <FullBleed>
            <section className="py-14 border-y border-border/50 bg-accent/5 backdrop-blur-sm">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.3em] mb-10">
                ...
                <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-40 grayscale hover:grayscale-0 transition-all duration-700 cursor-default">
                  {["FORTUNE 500", "GLOBAL TECH", "NYC FINANCE", "EU LOGISTICS"].map((brand) => (
                    <span
                      key={brand}
                      className="text-xl md:text-2xl font-serif font-black italic tracking-tighter hover:text-[#B45309] transition-colors"
                    >
                      {brand}
                    </span>
                  ))}
                      ...
                      >
                        <Card className="h-full border-none shadow-soft hover:shadow-glow-lg transition-all duration-500 group hover:-translate-y-3 rounded-3xl overflow-hidden bg-slate-50 dark:bg-slate-900/40">
                          <CardContent className="p-10">
                            ...
                            <p className="text-muted-foreground leading-relaxed mb-8 font-light">{service.description}</p>
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                  <div>
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-10 leading-[1.1]">
                      The Benchmark of <br /> Professional Success.
                    </h2>
                      ...
                      <div className="flex gap-6 group">
                        ...
                        <div>
                          ...
                          <p className="text-slate-400 font-light leading-relaxed">
                            Our long-term institutional partnerships are founded on consistent value delivery and absolute discretion.
                          </p>
                        </div>
                      </div>
                      <div className="flex gap-6 group">
                        ...
                        <div>
                          ...
                          <p className="text-slate-400 font-light leading-relaxed">
                            Navigating ultra-high-stakes negotiations with tactical precision and cross-border regulatory expertise.
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <section className="py-32 bg-[#0F172A] relative overflow-hidden border-t border-white/5">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                ...
                <Button
                  ...
                  variant="secondary"
                  asChild
                  className="px-16 h-20 text-xl font-bold rounded-full bg-white text-[#0F172A] hover:bg-[#B45309] hover:text-white transition-all shadow-2xl"
                >
